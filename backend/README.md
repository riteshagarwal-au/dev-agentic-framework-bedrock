...
This package uses [Hatchling](https://hatch.pypa.io/) as its build backend and is managed with
[`uv`](https://docs.astral.sh/uv/) (any standard `pip`/`venv` workflow also works).
